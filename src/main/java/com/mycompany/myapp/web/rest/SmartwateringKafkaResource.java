...
@RestController
@RequestMapping("/api/smartwatering-kafka")
public class SmartwateringKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SmartwateringKafkaResource.class);
    ...
    public SmartwateringKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
